 ...
 */
function blogic_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function blogic_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function blogic_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function blogic_sanitize_select( $input, $setting ) {
 ...
 */
function blogic_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 * - Control: number, tel
 */
function blogic_sanitize_number_range( $number, $setting ) {
	 ...
	 */
function blogic_santize_allow_tag( $input ) {
	$input = wp_kses(
		$input,
		array(
			'br'   => array(),
 ...
 */
function blogic_sanitize_html( $html ) {
 ...
 */
function blogic_sanitize_sort( $input ) {
