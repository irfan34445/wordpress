<?php
if ( ! class_exists( 'Blogic_Featured_Posts_Widget' ) ) {
	/**
	 * Adds Blogic Featured Posts Widget.
	 */
	class Blogic_Featured_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'blogic_featured_posts_widget',
				__( 'Blogic Featured Posts Widget', 'blogic' ),
